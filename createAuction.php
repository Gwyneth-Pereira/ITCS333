...
<body>
	...
	<form action=".php" method="POST" class="form-group w-25 mx-auto text-center">
        ...
        <p>End Time/Date:</p>
        <p><input type="datetime-local" id="meeting-time" name="meeting-time" value="<?php echo date('Y-m-d H:i:s'); ?>" min="<?php echo date('Y-m-d H:i:s'); ?>"
         max="<?php echo mktime(date("Y")+1, date("m"), date("d"), 0, 0, 0); ?>"></p>
